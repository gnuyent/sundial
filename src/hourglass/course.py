...
class Course:
	...
	def __init__(self, course_hours = "", course_title = "", course = "", description = "", footnotes = {}, full_title = "", general_text = "",  id = "", meetings = [Meeting()], period = 0, prerequisite = "", schedule_num = 0, seats_available = 0, seats_open = 0, section = 0, session = "", statement = "", units = 0.0, url = "", waitlist = True,):
